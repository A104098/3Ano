...
# 1. Quantos tokens são um número inteiro com sinal? aka Contar tokens inteiros com sinal + ou - 
import re
...
# 2.Quantos tokens começam com um símbolo alfabético minúsculo e terminam com um símbolo numérico? aka letra minúscula e terminam com número
